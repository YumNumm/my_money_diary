...
class _$_Receipt implements _Receipt {
  ...
  @override
  String toString() {
    return 'Receipt(id: $id, name: $name, description: $description, amount: $amount, categoryId: $categoryId, purchasedAt: $purchasedAt, createdBy: $createdBy, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description, amount,
      categoryId, purchasedAt, createdBy, createdAt);
...
abstract class _Receipt implements Receipt {
  const factory _Receipt(
      ...
      required final DateTime createdAt}) = _$_Receipt;
